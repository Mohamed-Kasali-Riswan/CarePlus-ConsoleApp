...
public class DoctorModel {
	...
	public DoctorModel(DoctorView doctorView) {
		view = doctorView;
	}
	...
	public boolean isDoctorPresent(String docId) {
		if(CareplusDB.getInstance().isDoctorPresentbyId(docId)) return true;
		return false;
	}
	...
	public void listAllDoctors() {
		...
		if(doctors.size()==0) view.noDoctors("");
		else view.showAllDoctors(doctors);
	}
